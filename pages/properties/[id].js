...
export default function PropertyDetail() {
  ...
  return (
    <>
      <Header />
      <div className="min-h-screen bg-[#F5F5DC] flex justify-center items-start pt-10 px-2">
        <div className="w-full max-w-3xl bg-white border border-[#E0E0E0] rounded-3xl shadow-2xl p-8 flex flex-col md:flex-row gap-10">
          ...
          <div className="flex-1 flex flex-col justify-center">
            <h2 className="text-3xl font-extrabold text-[#001F3F] mb-1 drop-shadow">
              {prop.name}
            </h2>
            ...
            <p className="text-2xl font-bold text-[#B8860B] mb-6">
